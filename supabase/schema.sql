...
-- 7. جدول تنبيهات التأخر والانصراف (delay_notices)
CREATE TABLE IF NOT EXISTS public.delay_notices (
    ...
    status TEXT NOT NULL DEFAULT 'pending_teacher', -- pending_teacher, pending_director, completed
    teacher_reason TEXT,
    teacher_signature_date DATE,
    director_opinion TEXT, -- accepted, rejected_with_deduction
    director_notes TEXT,
