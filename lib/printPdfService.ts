...
.badge{border:1.5px solid #0f766e;padding:3px 14px;border-radius:4px;font-weight:800;font-size:11.5pt;background:#f0fdfa;color:#115e59;white-space:nowrap;display:inline-block;letter-spacing:0.5px}
.lbl{color:#64748b}
...
<div class="hdr-c">
<img src="${MOE_LOGO_BASE64}" alt="وزارة التعليم" style="height: 55px; width: auto; object-fit: contain; margin-bottom: 4px;" />
<div class="badge">\u0645\u0633\u0627\u0621\u0644\u0629 \u063a\u064a\u0627\u0628</div>
</div>
<div class="hdr-l">
